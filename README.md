...
An implementation of Forward Selection and Backward Elimination feature selection algorithms — built from scratch in C++ for an Intro to AI course. Parses and normalizes Titanic data sets before performing chosen algorithm with verbose output. Uses KNN (Nearest Neighbor) classification and a simple k-fold cross validation of leave one out.
